...
const ozi = require("../SystemModels/dolar");
...
module.exports = async (message) => {
  ...
  if (message.author.bot) return;
	...
	const background = await loadImage("https://cdn.discordapp.com/attachments/1009775926336307310/1030468671610568704/Ramalcimlevel.png");            
